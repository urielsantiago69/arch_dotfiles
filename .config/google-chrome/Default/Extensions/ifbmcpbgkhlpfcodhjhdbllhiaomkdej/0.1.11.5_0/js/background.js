...
/*!****************************************************************************!*\
  !*** E:/Repos/1JS/ooui/packages/office-online-ccp/lib/copyPasteService.js ***!
  \****************************************************************************/
...
/*!************************************************************************!*\
  !*** E:/Repos/1JS/ooui/packages/office-online-ccp/lib/fileReaderEx.js ***!
  \************************************************************************/
...
/*!***************************************************************************************!*\
  !*** E:/Repos/1JS/ooui/packages/office-online-ccp/lib/getClipboardDataReturnValue.js ***!
  \***************************************************************************************/
...
/*!***********************************************************************!*\
  !*** E:/Repos/1JS/ooui/packages/office-online-ccp/lib/imageReader.js ***!
  \***********************************************************************/
...
/*!*****************************************************************!*\
  !*** E:/Repos/1JS/ooui/packages/office-online-ccp/lib/index.js ***!
  \*****************************************************************/
...
/* harmony import */ var _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @1js/office-online-ccp */ "../../packages/office-online-ccp/lib/index.js");
...
var CopyPasteMessageListener = /** @class */ (function () {
    ...
    CopyPasteMessageListener.prototype.onMessageExternal = function (message, sender, sendResponse) {
        switch (message.command) {
            case _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__["CopyPasteService"].testCommand:
                return this.copyPasteService.handleTestCommand(message, sender, sendResponse);
            case _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__["CopyPasteService"].pasteCommand:
                return this.copyPasteService.handlePasteCommand(message, sender, sendResponse);
            case _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__["CopyPasteService"].getClipboardDataCommand:
                return this.copyPasteService.handleGetClipboardDataCommand(message, sender, sendResponse);
            case _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__["CopyPasteService"].getAvailableCommandsCommand:
...
var fileReader = new _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__["FileReaderEx"]();
var imageReader = new _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__["ImageReader"](null /* logger */, fileReader);
var copyPasteService = new _1js_office_online_ccp__WEBPACK_IMPORTED_MODULE_0__["CopyPasteService"](null /* logger */, imageReader, window);
